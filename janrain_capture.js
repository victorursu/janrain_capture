...
Drupal.behaviors.rpxUIProfileFields = {
  attach: function (context, settings) {
    $('.janrain_capture-field-select', context).once('janrain_capture-field-select', function() {
      var mid = getMID(this);
      var map = settings.map;
      var janrain_capture_fields = settings.janrain_capture_fields;
console.log(janrain_capture_fields);
      ...
      $(this).bind('change keyup', function () {
        var fid = $(this).val();
        var path = fid in janrain_capture_fields ? janrain_capture_fields[fid].path : this.initialValue;
